...
const foldOuter: React.CSSProperties = {
  ...
  borderColor: "transparent transparent var(--note-border, #e8dcc8) transparent",
};
  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center gap-1.5 h-6 w-full rounded-md bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 text-[10px] font-medium transition-all"
      >
              ...
              >
                ...
                <div className="flex items-center justify-between px-3 pb-2 pt-1 shrink-0">
                  ...
                  <button
                    onClick={handleSend}
                    disabled={!text.trim()}
                    className="flex items-center gap-1 px-3 py-1 rounded-lg bg-primary hover:bg-primary/90 disabled:opacity-40 disabled:cursor-not-allowed text-primary-foreground text-[11px] font-medium transition-all"
                  >
                    <Send className="w-3 h-3" />
                    Enviar
                  </button>
